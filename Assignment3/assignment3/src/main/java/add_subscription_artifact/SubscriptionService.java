 ...
 * 
 */
@WebServiceClient(name = "SubscriptionService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8081/soap_add_subscription?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SUBSCRIPTIONSERVICE_QNAME = new QName("http://soap/", "SubscriptionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/soap_add_subscription?wsdl");
    ...
    public Subscription getSubscriptionPort() {
        return super.getPort(new QName("http://soap/", "SubscriptionPort"), Subscription.class);
    }
    ...
    public Subscription getSubscriptionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "SubscriptionPort"), Subscription.class, features);
    }
